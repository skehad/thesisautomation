package com.ehadrafi.theproject101.adapters;
...
import com.ehadrafi.theproject101.ChatRoomActivity;
import com.ehadrafi.theproject101.R;
import com.ehadrafi.theproject101.models.Conversation;
        ...
        mUserReference.child(id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                holder.layout.setOnClickListener(view -> {
                    ...
                    clearUnreadChat(conversation1.getChatWithId());
                    Intent intent = new Intent(mContext, ChatRoomActivity.class);
                    intent.putExtra(ChatRoomActivity.EXTRAS_USER, user);
                    intent.putExtra("userUid", conversation1.getChatWithId());
